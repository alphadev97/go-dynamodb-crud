...
import (
	...
	"github.com/alphadev97/go-dynamodb-crud/internal/entities"
...
func (r *Rules) createTable(connection *dynamo.DynamoDB) error {
	table := &product.Product{}

	input := &dynamodb.CreateTableInput{
		AttributeDefinitions: []*dynamodb.AttributionDefinition{
			{
